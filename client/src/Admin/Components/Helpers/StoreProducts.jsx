...
function StoreProducts({ setProductItemId, setSelectedCard, data, pagination, quantityToDisplay, noPerPage }) {
       ...
       <div className="flex items-center justify-center gap-3 small-pc:mb-4 flex-wrap w-full">
        {
            productsToDisplay?.map((item, idx) => (
                <Product setProductItemId={setProductItemId} setSelectedCard={setSelectedCard} key={idx} data={item} />
            ))
        }
      </div> 
