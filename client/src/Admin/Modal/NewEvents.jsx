    ...
    <div className="flex flex-col gap-4 h-[70vh] overflow-y-auto scrollbar-thin">
      ...
      <form className="flex flex-col gap-4">
        <div className="inputGroup gap-1">
            ...
            <input type="text" className="input p-2" placeholder="Enter Title" />
        </div>
        <div className="inputGroup gap-1">
        ...
        <div className="inputGroup gap-1">
            ...
            <input type="date" min={todayDate} className="input p-2" placeholder="Enter Title" />
        </div>
        <div className="inputGroup gap-1">
        ...
        <div className="inputGroup gap-1">
            ...
            <input type="file" className="input p-2" placeholder="Enter Author" />
        </div>
        <div className="inputGroup gap-1">
